...
populationSizeOfEachGeneration=50
maxGenerations=50
...
def generate(CONST_reactants,CONST_products,globalDict):
    ...
    for generationNum in range(1,maxGenerations):
        ...
        for dict in dictsListOfThisGeneration:
            ...
            gradesListOfThisGeneration.append((dict,grade))  
            inCounter += 1                 
        ...
        print ('\033[41m'+'TEST: inCounter:%s GradeList: %s'%(inCounter,[gradd[1] for gradd in gradesListOfThisGeneration])+'\033[0m')                                   
