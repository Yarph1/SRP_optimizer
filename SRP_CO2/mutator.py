...
class mutator(object):
    ...
    def __init__(self,chromoDict,generationNum,DIST=0.001,rateChromo=1.0,rateGene=1.0):
        ...
        self.DIST=DIST 
        self.rateCromo=rateChromo/generationNum # a number in the range [0,1]
        self.rateGene=rateGene/generationNum    
